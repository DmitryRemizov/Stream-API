    ...
    public class Main {
        public static void main(String[] args) {
            ...
            long countOfMinor = persons.stream()
                    ...
                    .count();
            System.out.println("Количество несовершеннолетних: " + countOfMinor);
            ...
            System.out.println("Список фамилий призывников: " + listOfConscripts);
            ...
            List<String> sortedListPotentiallyWorkingPeople = persons.stream()
                    ...
                    .map(Person::getFamily)
                    .collect(Collectors.toList());
            System.out.println("Список потенциально работоспособных людей с высшим образованием: " + sortedListPotentiallyWorkingPeople);
        }
    }